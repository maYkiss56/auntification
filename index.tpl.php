...
<head>
	...
	<!-- [link] -->
	<link rel="stylesheet" type="text/css" href="assets/css/main.css" id="them"> <!-- [main.css] -->
	...
	<script src="./assets/js/them.js" defer></script>
	<script src="./assets/js/main.js" defer></script>
	<script src="./assets/js/functions.js" defer></script>
	<script src="./assets/js/check.js" defer></script>

	<!-- [title] -->
	<title>JS-Test | Project</title>
</head>
<body>
	...
	<section class="authorization">
		...
		<div class="authorization__content">
			<div class="authorization__clue">
				...
				<a href="reset.tpl.php">Забыл пароль?</a>
				<h3 class="pt">Регистрация</h3>
				<p>Если у вас нет аккаунта</p>
				<a href="register.tpl.php">Зарегистрироваться тут.</a>
			</div>
			<!-- action="./assets/php/login.php" method="post" -->
			<form class="reset__user authorization__user">
				...
				<div class="authorization__check">
					<label>
						<input class="authorization__checkbox" type="checkbox" name="remember">
						<div class="authorization__checkbox--style"></div>
						Запомнить вход с этого устройства
					</label>
				</div>
				<button type="submit" class="authorization__auto" id="open-model-btn">войти на сайт</button>
			</form>
